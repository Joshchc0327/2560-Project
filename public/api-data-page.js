...
//                 namePara.textContent = `Name: ${doc.name}`;
//                 const emailPara = document.createElement('p');
//                 emailPara.textContent = `Email: ${doc.email}`;
...
//                 const div = document.createElement('div');
//                 div.className = 'data-item';
//                 // You may want to format this data instead of just stringifying the JSON
//                 div.textContent = `Name: ${doc.name}, Email: ${doc.email}`;
//                 container.appendChild(div);
//             });
//         })
//         .catch(error => {
...
//           const div = document.createElement('div');
//           div.className = 'data-item';
//           div.textContent = JSON.stringify(doc);
//           container.appendChild(div);
//         });
//       })
//       .catch(error => {
